...
class AirQualityCard extends StatelessWidget {
  ...
  List<Color> qualityColor(){
    switch(quality){
      ...
      case("Poor"):{
        return const [Color.fromARGB(255, 255, 61, 61), Color.fromARGB(255, 255, 125, 65)];
      }
      case("Okey"):{
        return const [Color.fromARGB(255, 255, 184, 78), Color.fromARGB(255, 255, 237, 73)];
      }
      default: return const [Color(0xFF05FF00), Color(0xFF00FFFF)];
    }
  }
